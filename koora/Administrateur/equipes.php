            ...
            <div class="row justify-content-center">
                <div class="col-xl-5">
                    <div class="section_tittle text-center">
                        <h4>Liste des équipes sportifs</h4>
...
$Id_Cp=$enreg['Id_Eq'];
$Nom_Eq=$enreg['Nom_Eq'];
$Logo_Eq=$enreg['Logo_Eq'];
$Date_C_Eq=$enreg['Date_C_Eq'];

//}
  ?>
                <div class="col-md-6 col-xl-6">
                    <div class="upcoming_event_1">
                        <img src="../uploadLE/<?php echo $Logo_Eq;?>" alt="#" width="500" height="400" >
                        <div class="upcoming_event_text">
                            <div class="date">
                                <h3><?php echo $Nom_Eq;?> </h3>
                            </div>
                            <div class="time">
                                <ul class="list-unstyle">
                                    <li> <span class="ti-time"></span> <?php echo $Date_C_Eq;?></li>
