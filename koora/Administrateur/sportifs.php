                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                 <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a  href="equipements.php" class="nav-link">Equipements</a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a  href="competitions.php" class="nav-link"> Compétitions</a>
                                    </li>
                                    <li class="nav-item">
                                        <a  href="terrains.php" class="nav-link">Terrains</a>
                                    </li>
                                    <li class="nav-item">
  ...
  ?>
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img     src="../uploadS/<?php echo $Photo_S;?>" width="400" height="300"  class="card-img-top" alt="blog">
                            <div class="card-body">
                               
                               <span class="dot"><?php echo $Nom_S." ".$Prenom_S;?> </span>
                                <a href=""><h5 class="card-title"><?php echo $Adr_S;?> </h5></a>
                                <a href=""><h5 class="card-title"><?php echo $Email_S;?> </h5></a>
                                <ul>
                                    <li> <span class="ti-layers"></span><?php echo $Date_N_S;?></li>
                                    <li> <span class="ti-comments"></span><?php echo $Tel_S;?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
