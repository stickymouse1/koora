                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-md-8 col-xl-6">
                      <div class="sub_header_social_icon float-right">
                        <?php echo("<i><strong><font face='Arial Black, Gadget, sans-serif' size='+2' color='#000033'></font></strong></i> <i><strong><font face='Trebuchet MS, Arial, Helvetica, sans-serif' size='+2' color='#990000'>".$Login."</font></strong></i>"); ?>
