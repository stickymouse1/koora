     ...
     <!-- player info part start-->
      <section class="team_member section_padding padding_less_40">
         <div class="container">
           ...
           <div align="center">
            <?php $Id_Cp=$_GET['Id_Cp'];?>
  <form id="form1" name="form" method="post" action="participer_cp'.php" enctype="multipart/form-data">
  <p><i><strong><font face='Trebuchet MS, Arial, Helvetica, sans-serif' size='+1' color='#FF9966'><h1>  Prêt à gagner, remporter de trophées </h1></font></strong></i></p>
  <p><h2><i><font face='Trebuchet MS, Arial, Helvetica, sans-serif'  color='#FF9966'>Amusez-vous sur de terrains de jeu  professionnels </font></i></h2></p>
     <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Compétiton </font></i></label>
  <select name="Id_Cp" required>
  <option value="">[Choisir]</option>
        <?php
		   	
   require_once'../connexion.php';

$rq="SELECT * FROM `competition`";
...
while ($dt=mysql_fetch_row($result))
{
 ...
 if($dt[0]==$Id_Cp)
	{
 // Remplir la liste déroulante des catégorie
 echo "\t\t<option value=".($dt[0])." selected>".($dt[3])."</option>";
	}
	else
	{
 // Remplir la liste déroulante des catégorie
...
?>
  ...
  <p>
<button class="button"  type="submit" style="vertical-align:middle" onClick="return valider();"><span>Participer </span></button>    <button class="button"  type="reset" style="vertical-align:middle"><span>Annuler </span></button>
