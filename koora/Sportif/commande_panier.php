     ...
     <!-- player info part start-->
      <section class="team_member section_padding padding_less_40">
         <div class="container">
           ...
           <div align="center">
  <form id="form1" name="form" method="post" action="commande'.php" enctype="multipart/form-data">
  <p><h1>Passer votre commande en un click   </h1></p>
 
   <input type="hidden" name="hi_temp"  value="">
<p>  <fieldset style="width: 1000px">
	<legend><strong><font face='Century Gothic' color='#3a9dca' size='+4'   >Choix d'équipements: </font></strong></legend>
   <br><br><div id="msg"></div> <div id="msg1"></div><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Liste des Equipements sportifs  </font></i>
...
$rq="SELECT * FROM `equipement`,`panier`,`regrouper`,sportif,`terrain` where `sportif`.Id_S=panier.Id_S and `panier`.Id_P=`regrouper`.Id_P and`regrouper`.Ref_Eq=`equipement`.Ref_Eq  and Email_S='$Login' and Pwd_S='$Pwd' and `terrain`.`Id_T` =`equipement`.`Id_T`";
...
?>
			 ...
			 <input type="button" name="button" id="button" onClick="ajouter_modul()" class="button button1"  value=" >>>">           
			  ...
			  <input  name="button" id="button" type="button" onClick="enlever_modul(this.form)"  class="button button1"  value=" <<<">
                <br><br>
			<i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Equipement retenus </font></i>
  ...
  face="Times New Roman, Times, serif" size="+2" color="#000033">Date d'envoi </font></i></label>
    <input type="date" id="fname" name="Date_E_Cde"  required>
  </p>
   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Date de livraison </font></i></label>
    <input type="date" id="fname" name="Date_L_Cde"  required>
  </p>
   ...
   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Détails commande </font></i></label>
    <textarea name="Details_Cde" placeholder="Saisir les détails associés .." required cols="150" rows="10"></textarea>
  </p>
  <p>&nbsp;</p>
 
  <p>
<button class="button"  type="submit" style="vertical-align:middle" onClick="return valider();"><span>Commander </span></button>    <button class="button"  type="reset" style="vertical-align:middle"><span>Annuler </span></button>
