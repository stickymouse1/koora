...
<body>
    ...
    <div align="center">
  <form id="form1" name="form1" method="post" action="equipe'.php" enctype="multipart/form-data">
 
  
 
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Equipe </font></i></label>
    <input type="text" id="fname" name="Nom_Eq" placeholder="Saisir le nom  d'equipe  .." required>
  </p>
  
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Date de création  </font></i></label>
    <input type="date" id="fname" name="Date_C_Eq"  required>
  </p>
    ...
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Logo </font></i></label>
    <input type="file" id="fname" name="Logo_Eq" placeholder="Sélectionner le logo  d'équipe .." required>
  </p>
  <p>&nbsp;</p>
