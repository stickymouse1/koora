...
<div align="center">
  <form id="form1" name="form1" method="post" action="inscription'.php" enctype="multipart/form-data">
 
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Nom </font></i></label>
    <input type="text" id="fname" name="Nom_S" placeholder="Saisir votre nom .." required>
  </p>
 
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Prénom </font></i></label>
    <input type="text" id="fname" name="Prenom_S" placeholder="Saisir votre prénom .." required>
  </p>
 
 <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Date de naissance </font></i></label>
    <input type="date" id="fname" name="Date_N_S"  required>
  </p>
   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">E-mail </font></i></label>
    <input type="text" id="fname" name="Email_S" placeholder="Saisir votre E-mail .." required>
  </p>
   
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Telephone </font></i></label>
    <input type="number" id="fname" name="Tel_S" placeholder="Saisir votre telephone .." required>
  </p>
   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Mot de passe </font></i></label>
    <input type="password" id="fname" name="Pwd_S" placeholder="Saisir votre mot de passe .." required>
  </p>
 
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Adresse </font></i></label>
  <input type="text" id="fname" name="Adr_S" placeholder="Saisir votre adresse .." required>
   
  </p>
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Photo </font></i></label>
    <input type="file" id="fname" name="Photo_S" placeholder="Sélectionner votre photo de profil .." required>
  </p>
  <p>&nbsp;</p>
