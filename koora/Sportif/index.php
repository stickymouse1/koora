            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="upcoming_event_1">
                         <img src="../uploadS/<?php echo $Photo_S;?>"        width="500"   height="600"      alt="">
                        <div class="upcoming_event_text">
                            <div class="date">
                                <h3><?php echo $Nom_S;?> <span><?php echo $Prenom_S;?></span> </h3>
                            </div>
                            <div class="time">
                                <ul class="list-unstyle">
                                    <li> <span class="ti-time"></span> <?php echo $Date_N_S;?></li>
                                    <li> <span class="ti-location-pin"></span> <?php echo $Tel_S;?></li>
                                </ul>
                            </div>
                            <p><?php echo $Adr_S;?> </p>
                             <p><?php echo $Email_S;?> </p>
