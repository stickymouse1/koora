...
<body>
  ...
  $req="SELECT * FROM `competition`,`terrain` where `terrain`.`Id_T` =`competition`.`Id_T` ";
...
$Id_Cp=$enreg['Id_Cp'];
$Nom_Cp=$enreg['Nom_Cp'];
$Type_Cp=$enreg['Type_Cp'];
$Date_D_Pp=$enreg['Date_D_Pp'];
$Date_F_Cp=$enreg['Date_F_Cp'];
$Affiche_Cp=$enreg['Affiche_Cp'];
$Nom_T=$enreg['Nom_T'];
$Type_Cp=$enreg['Type_Cp'];
$Maps_T=$enreg['Maps_T'];
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 col-xl-5">
                                <div class="player_info_img">
                                 <p><i><strong><font face='Trebuchet MS, Arial, Helvetica, sans-serif' size='+1' color='#FF9966'><h1>Vivre la passion de FOOTBALL</h1></font></strong></i></p>
  <p><h2><i><font face='Trebuchet MS, Arial, Helvetica, sans-serif'  color='#FF9966'>Participer à des tournois ouvertes aux entreprises, aux groupes et aux associations </font></i></h2></p>
     <p>
                                
                                    <img src="../uploadComp/<?php echo $Affiche_Cp;?>" alt="">
                                </div>
                            </div>
                            <div class="col-md-6 offset-xl-1 col-xl-5">
                                <div class="player_info_text">
                                   <i><strong><font color="#339900" face="Times New Roman, Times, serif"  size="+6"> <h1><?php echo $Nom_Cp;?></h1></font></strong></i>
                                    <h2><?php echo $Nom_T;?></h2>
                                    <a href="#" class=""><font color="#009933"><?php echo $Date_D_Pp." A ".$Date_F_Cp;?></font></a> 
                                     <p><?php echo $Maps_T;?></p>
                                </div>
                            </div>
                        </div>
                        <hr size="+2" color="#FF9966">
                                 ...
                                 <p> <a href="participer_cp.php?Id_Cp=<?php echo $Id_Cp;?>" class="register_icon"><i class="ti-arrow-right"></i><i><strong><font face='Trebuchet MS, Arial, Helvetica, sans-serif' size='+1' color='#FF9966'>Participer au tournoi</font></strong></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                                   <hr size="+2" color="#FF9966">
                    </div>
