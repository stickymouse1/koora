...
<body>
   ...
   // $Ref_A = $_POST["Ref_A"];
	 $hi_temp = $_POST["hi_temp"];
	   ...
	   //$Date_F = $_POST["Date_F"];
	 $Id_T = $_POST["Id_T"];
	  $Id_SP_Ab = addslashes($_POST["Id_SP_Ab"]);
	 
$Type_Ab = addslashes($_POST["Type_Ab"]); 

$Date_PS_Ab = addslashes($_POST["Date_PS_Ab"]); 
$Details_Ab = addslashes($_POST["Details_Ab"]); 
	//echo($hi_temp."<br>");
		//echo($hi_temp1 ."<br>");
		//echo($Date_L."<br>");
		//echo($Id_SP_Ab."<br>");
...
$Prenom_S=$enreg1['Prenom_S'];
		...
		//echo($prenom_cl."<br>");
		$date = date("Y-m-d");
		//$Type_Ab="Object: ".$Id_L." Articles :".$hi_temp." Details abonnement: ".$Id_SP_Ab;
			$requete = "INSERT INTO `abonnement`(`Id_Ab`, `Type_Ab`, `Etat_AB`, `Date_PS_Ab`, `Date_D_Ab`, `Details_Ab`, `Id_SP_Ab`, `Id_T`) VALUES ('','$Type_Ab','En attente','$Date_PS_Ab','$date','$Details_Ab','$Id_SP_Ab','$Id_T')";
 ...
 exit (); 
		 ...
		 $q1="SELECT Id_Ab FROM abonnement  where 1  ORDER BY `abonnement`.`Id_Ab` Desc";
	 $p1= mysql_query ($q1) or die ("Select impossible");
	  $res1=mysql_fetch_array($p1);
			 ...
			 $data =explode("/", $hi_temp);
							   ...
							   if($part)
							   {
							    $requete = "INSERT INTO `equipe_abonnees`(`Id_Eq`, `Id_Ab`) VALUES ('$part','$Id_Ab')";
    $result = @mysql_query($requete);
							   }
								}
	 ...
	 echo("<center><h3 class='head1'>Demande d'abonement </h3></center>");
	 echo("<p align='right'><strong><font face='Century Gothic' color='#660000' size='+2'  >Date:</font></strong><font face='verdana' color='#000033' size='+1'> ". $date."</font></p>");
	  ...
	  $rq33="SELECT * FROM `saison_sportive`  where`saison_sportive`.`Id_SP`='$Id_SP_Ab'";
	 $q33= mysql_query ($rq33) or die ("Select impossible");
	  $res33=mysql_fetch_array($q33);
		     $Saison=$res33['Saison'];
	  echo("<p align='left'><strong><font face='Century Gothic' color='#660000' size='+2'  >Saison sportive:</font></strong><font face='verdana' color='#000033' size='+1'> ". $Saison."</font></p>");
			echo("<p align='center'><strong><font face='Century Gothic' color='#660000' size='+2'  >Re&ccedil;u N&deg; :</font></strong><font face='verdana' color='#3a9dca' size='5'> ".$Id_Ab."</font></p>");
		  ...
		  echo ("<p align='left'><strong><font face='Century Gothic' color='#660000' size='+2'  >Type d'abonnement: </font></strong><font face='Century Gothic' size='5' color='#000033' >".  $Type_Ab."</font></p>");
		    echo ("<p align='left'><strong><font face='Century Gothic' color='#660000' size='+2'  >Date de  demande : </font></strong><font face='Century Gothic' size='5' color='#000033' >".  $date."</font></p>");
			  echo ("<p align='left'><strong><font face='Century Gothic' color='#660000' size='+2'  >Date de première séance d'entrainement : </font></strong><font face='Century Gothic' size='5' color='#000033' >".  $Date_PS_Ab."</font></p>");
		
		   $data =explode("/", $hi_temp);
		   $part1=$data [0];
		  echo ("<p align='left'><strong><font face='Century Gothic' color='#660000' size='+2'  >Terrain :</font></strong>");
							   //$data =explode("/", $hi_temp);
							   $req12="SELECT * FROM `terrain`  where `terrain`.`Id_T` ='$Id_T'";
...
echo ("</p>");
echo ("<p align='left'><strong><font face='Century Gothic' color='#660000' size='+2'  >Liste d'équipes abonnées :</font></strong>");
 $data =explode("/", $hi_temp);
							   foreach($data as $part)
							   {
							   $part = str_replace(":", " ",$part);
							   $req22="SELECT * FROM `equipe` where `equipe`.`Id_Eq` ='$part'";
$res22=mysql_query($req22) or die (mysql_error()) ; 
$r22=mysql_fetch_array($res22);

$Nom_Eq=$r22['Nom_Eq'];

							   echo ("<font face='Century Gothic' size='5' color='#000033' >". $Nom_Eq." &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "."</font>");
								}
								
		 echo ("</p>");
		 
		
				   echo("<p align='left'><strong><font face='Century Gothic' color='#660000' size='+2'  >Détails:</font></strong><font face='Century Gothic' size='5' color='#000033' >".$Details_Ab."  </font>  </p> ");
