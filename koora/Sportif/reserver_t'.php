...
<body>
  ...
  $Heure_M=addslashes($_POST['Heure_M']);
  //echo($Heure_M."<br>");
 ...
 // echo($Details_R."<br>");
  ...
  //echo($Date_N_CI."<br>");                                                  
   $Details_R=addslashes($_POST['Details_R']);
 // echo($Details_R."<br>");                                                                                              
...
$Photo_S=$enreg['Photo_S'];
 ...
 //echo( $Ref_P);
 $date1 = date("Y-m-d");
  $req="INSERT INTO `reservation`(`Id_R`, `Id_S`, `Id_T`, `Date_R`, `Etat_R`, `Date_M`, `Heure_M`, `Details_R`) VALUES
   ('','$Id_S','$Id_T','$date1','En attente','$Date_M','$Heure_M','$Details_R')";
  $res=mysql_query($req) or die (mysql_error()) ; 
if($res)
{
...
$Nom_T=$r['Nom_T'];
echo("<p align='middle'><strong><font face='Calibri'  size='6' color='#336600'>Réservation de terrain : <strong><font face='Calibri'  size='7' color='#00FF99'> ". $Nom_T."  par le sportif : <strong><font face='Calibri'  size='7' color='#00FF99'> ". $Nom_S." ".$Prenom_S."</fond></strong><font face='Calibri'  size='6' color='#336600'> effectue avec succés</font></strong><br> ");
		echo("<a href='terrains.php'><font face='Calibri'  size='6' color='#CC0099'>Retour</font> </a>");
}
else
{
