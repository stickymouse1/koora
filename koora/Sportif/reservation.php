     ...
     <!-- player info part start-->
      <section class="team_member section_padding padding_less_40">
         <div class="container">
           ...
           <div align="center">
            <?php //$Id_T=$_GET['Id_T'];?>
  <form id="form1" name="form1" method="post" action="reserver_t'.php" enctype="multipart/form-data">
  <p><i><strong><font face='Trebuchet MS, Arial, Helvetica, sans-serif' size='+1' color='#FF9966'><h1>Louer de terrains pour organiser des évènements sportifs adaptés à chacun </h1></font></strong></i></p>
  <p><h2><i><font face='Trebuchet MS, Arial, Helvetica, sans-serif'  color='#FF9966'>PROFITEZ DES INFRASTRUCTURES MODULABLES ET INNOVANTES</font></i></h2></p>
     <p>
...
?>
  ...
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Date de match </font></i></label>
    <input type="date" id="fname" name="Date_M"  required>
  </p>
 <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Heure de match </font></i></label>
    <input type="time" id="fname" name="Heure_M"  placeholder="Saisir l'heure de match" required>
  </p>
  
<p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Détails  </font></i></label>
     <textarea name="Details_R" placeholder="Saisir les détails de réservation .." required cols="150" rows="10"></textarea>
  </p>
  ...
  <p>
<button class="button"  type="submit" style="vertical-align:middle"><span>Réservez </span></button>    <button class="button"  type="reset" style="vertical-align:middle"><span>Annuler </span></button>
