                           ...
                           <div class="tean_content">
                              ...
                              <p><?php echo $Nom_T;?></p>
                               <p><?php echo $Prix_Eq;?></p>
                                ...
                                <div class="sub_header_social_icon float-right">
                                 <p> <a href="panier.php?Ref_Eq=<?php echo $Ref_Eq;?>" class="register_icon"><i class="ti-arrow-right"></i><i><strong><font face='Trebuchet MS, Arial, Helvetica, sans-serif' size='+1' color='#FF9966'>Ajouter au panier</font></strong></i></a></p>
                                 </div>
                           </div>
