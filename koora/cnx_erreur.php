                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <li class="nav-item">
                                        <a  href="#" class="nav-link">Sportifs</a>
                                    </li>
                                    <li class="nav-item">
                                        <a   href="#" class="nav-link">Equipes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a  href="#" class="nav-link">Equipements</a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a  href="#" class="nav-link">Terrains</a>
                                    </li>
                                    <li class="nav-item">
                                        <a   href="#" class="nav-link"> Propriétaires</a>
                                    </li>
                                     <li class="nav-item">
                                        <a    href="cnx.php" class="nav-link"> Connexion</a>
                                    </li>
                                </ul>
...
<div align="center">
  <form id="form1" name="form1" method="post" action="cnx'.php">
   <p align="center"><font color="#FF0000" size="+3"  face="Trebuchet MS, Arial, Helvetica, sans-serif">Veuillez vérifier vos paramètres d'accès</font> </p>
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Nom d'utilisateur</font></i></label>
    <input type="text" id="fname" name="Login" placeholder="Saisir votre nom d'utilisateur.." required>
  </p>
 
  <p>
    <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Mot de passe</font></i></label>
    &nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="Pwd" placeholder="Saisir votre mot de passe.." required />
     <div id="B"></div>
</p>
  ...
  <p>&nbsp;</p>
   <details>
 <summary><i><strong><font  face="Arial Black, Gadget, sans-serif" size="+2"  color="#FF6633">S'inscrire</font></strong></i></summary>
  <p>&nbsp;</p>
 <p><i><strong><font face="MS Serif, New York, serif" size="+2"   color="#000066"><a  href="Sportif/inscription.php">Sportif</a></font></strong></i></p>
  <p><i><strong><font face="MS Serif, New York, serif"  size="+2" color="#000066"><a  href="Proprietaire/inscription.php">Propriétaire </a></font></strong></i></p>
 </details>

  <p>
   <button type="submit" class="button button-contactForm" style="vertical-align:middle"><span><font  color="#000000">Connexion</font> </span></button>
     <button type="reset" class="button button-contactForm" style="vertical-align:middle"><span><font  color="#000000">Annuler</font> </span></button>
