...
$Photo_P=$enreg['Photo_P'];
  ...
  ?>
    <div align="center">
  <form id="form1" name="form1" method="post" action="equipement'.php" enctype="multipart/form-data">
 
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Terrain </font></i></label>
   <select name="Id_T" id="select2"  required>
    <option value="">[Choisir]</option>
        <?php
		   	
   require_once'../connexion.php';

$rq="SELECT * FROM `terrain`,`proprietaire` where `proprietaire`.Id_P=`terrain`.`Id_P` and  `proprietaire`.Id_P='$Id_P'  ";
...
?>
  ...
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Désignation </font></i></label>
    <input type="text" id="fname" name="Designation_Eq" placeholder="Saisir la désignation d'équipement  .." required>
  </p>
  ...
  <select name="Categorie_Eq" required>
  <option value="-1">[Choisir]</option>
  <option>Ballon</option>
  <option>T-shirt</option>
   <option>Short</option>
  <option>Bus</option>
  <option>Véstiaire</option>
  <option>Eau minérale</option>
   <option>Pair de chaussures</option>
  </select>
  ...
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Prix  </font></i></label>
    <input type="text" id="fname" name="Prix_Eq" placeholder="Saisir le prix d'équipement  .." required>
  </p>
   
 
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Description </font></i></label>
  <textarea name="Description_Eq" cols="160" rows="10" placeholder="Saisir la déscription d'équipement  .."></textarea>
  ...
  face="Times New Roman, Times, serif" size="+2" color="#000033">Photo </font></i></label>
    <input type="file" id="fname" name="Photo_Eq" placeholder="Sélectionner l'affichee  d'équipement .." required>
  </p>
  <p>&nbsp;</p>
