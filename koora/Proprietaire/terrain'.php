...
<body>
    ...
    <div align="center">
 <?php 
  $Nom_T=addslashes($_POST['Nom_T']);
  //echo($Nom_T."<br>");
  
    $Adr_T=addslashes($_POST['Adr_T']);
 // echo($Adr_T."<br>");
   $Categorie_T=addslashes($_POST['Categorie_T']);
 // echo($Categorie_T."<br>");
    $Prix_Location_T=addslashes($_POST['Prix_Location_T']);
  //echo($Prix_Location_T."<br>");                                                  

  //echo($Poids_CI."<br>");  
  

   $Maps_T=addslashes($_POST['Maps_T']);
   $Superficie_T=addslashes($_POST['Superficie_T']);
 // echo($Email_Arch."<br>");  
   $fichier = basename($_FILES['Affiche_T']['name']);
  ...
  if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
{
     ...
     if(move_uploaded_file($_FILES['Affiche_T']['tmp_name'], $dossier . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
     {
  $req="INSERT INTO `terrain`(`Id_T`, `Nom_T`, `Adr_T`, `Maps_T`, `Categorie_T`, `Prix_Location_T`, `Superficie_T`, `Affiche_T`, `Id_P`) VALUES
   ('','$Nom_T','$Adr_T','$Maps_T','$Categorie_T','$Prix_Location_T','$Superficie_T','$fichier','$Id_P')";
  $res=mysql_query($req) or die (mysql_error()) ; 
if($res)
{
	echo("<p align='middle'><strong><font face='Calibri'  size='6' color='#336600'>Ajout de terrain : <strong><font face='Calibri'  size='7' color='#00FF99'> ". $Nom_T."  par le propriétaire : <strong><font face='Calibri'  size='7' color='#00FF99'> ". $Nom_P." ".$Prenom_P."</fond></strong><font face='Calibri'  size='6' color='#336600'> effectue avec succés</font></strong><br> ");
		echo("<a href='terrain.php'><i><strong><font face='Calibri'  size='6' color='#669999'>Retour</font></strong></i> </a>");
}
else
{
