...
$Photo_P=$enreg['Photo_P'];
  ...
  ?>
    <div align="center">
  <form id="form1" name="form1" method="post" action="competition'.php" enctype="multipart/form-data">
...
?>
  ...
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Compétition </font></i></label>
    <input type="text" id="fname" name="Nom_Cp" placeholder="Saisir la désignation d'équipement  .." required>
  </p>
  ...
  <select name="Type_Cp" required>
  <option value="-1">[Choisir]</option>
  <option>Tournoi amical</option>
  <option>Tounroi régional</option>
   <option>Tournoi nationnal</option>
  <option>Tournoi internationnal</option>
  ...
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Date de début  </font></i></label>
    <input type="date" id="fname" name="Date_D_Pp"  required>
  </p>
   
 
   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Date de fin  </font></i></label>
    <input type="date" id="fname" name="Date_F_Cp"  required>
  </p>
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Photo </font></i></label>
    <input type="file" id="fname" name="Affiche_Cp" placeholder="Sélectionner l'affichee  de compétition .." required>
  </p>
  <p>&nbsp;</p>
