...
<div align="center">
  ...
  face="Times New Roman, Times, serif" size="+2" color="#000033">Nom </font></i></label>
    <input type="text" id="fname" name="Nom_P" placeholder="Saisir votre nom .." required>
  </p>
 
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Prénom </font></i></label>
    <input type="text" id="fname" name="Prenom_P" placeholder="Saisir votre prénom .." required>
  </p>
  ...
  face="Times New Roman, Times, serif" size="+2" color="#000033">E-mail </font></i></label>
    <input type="text" id="fname" name="Email_P" placeholder="Saisir votre E-mail .." required>
  </p>
   
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Telephone </font></i></label>
    <input type="number" id="fname" name="Tel_P" placeholder="Saisir votre telephone .." required>
  </p>
   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Mot de passe </font></i></label>
    <input type="password" id="fname" name="Pwd_P" placeholder="Saisir votre mot de passe .." required>
  </p>
 
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Adresse </font></i></label>
  <input type="text" id="fname" name="Adr_P" placeholder="Saisir votre adresse .." required>
   
  </p>
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Photo </font></i></label>
    <input type="file" id="fname" name="Photo_P" placeholder="Sélectionner votre photo de profil .." required>
  </p>
  <p>&nbsp;</p>
