...
<div align="center">
 ...
 // echo($Email_P."<br>");
  ...
  //echo($Poids_CI."<br>");  
   ...
   $Adr_P=addslashes($_POST['Adr_P']);
   $Pwd_P=$_POST['Pwd_P'];
 // echo($Email_Arch."<br>");  
   $fichier = basename($_FILES['Photo_P']['name']);
  ...
  if(!isset($erreur)) //S'il n'y a pas d'erreur, on upload
{
     ...
     if(move_uploaded_file($_FILES['Photo_P']['tmp_name'], $dossier . $fichier)) //Si la fonction renvoie TRUE, c'est que ça a fonctionné...
     {
  $req="INSERT INTO `proprietaire`(`Id_P`, `Nom_P`, `Prenom_P`, `Adr_P`, `Tel_P`, `Email_P`, `Pwd_P`, `Photo_P`) VALUES
   ('','$Nom_P','$Prenom_P','$Adr_P','$Tel_P','$Email_P','$Pwd_P','$fichier')";
  $res=mysql_query($req) or die (mysql_error()) ; 
if($res)
{
	echo("<p align='middle'><strong><font face='Calibri'  size='6' color='#336600'>Inscription Propriétaire du terrain: <strong><font face='Calibri'  size='7' color='#00FF99'> ". $Nom_P." ".$Prenom_P."</fond></strong><font face='Calibri'  size='6' color='#336600'> effectue avec succés</font></strong><br> ");
