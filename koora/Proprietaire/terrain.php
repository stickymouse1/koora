...
<body>
                               ...
                               <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item"  href="terrains.php">Mes terrains</a>
                                        </div>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div align="center">
  <form id="form1" name="form1" method="post" action="terrain'.php" enctype="multipart/form-data">
 
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Nom </font></i></label>
    <input type="text" id="fname" name="Nom_T" placeholder="Saisir le nom du terrain .." required>
  </p>
 
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Adresse </font></i></label>
    <input type="text" id="fname" name="Adr_T" placeholder="Saisir l'adresse de terrain  .." required>
  </p>
 

   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Catégorie </font></i></label>
  <select name="Categorie_T" required>
  <option value="-1">[Choisir]</option>
  <option>TERRAIN HYBRIDE</option>
  <option>TERRAIN EN HERBE</option>
  <option>TERRAIN SYNTHÉTIQUE</option>
  </select>
  ...
  <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Prix de location </font></i></label>
    <input type="text" id="fname" name="Prix_Location_T" placeholder="Saisir le prix de location  .." required>
  </p>
   <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Supérifcie </font></i></label>
    <input type="text" id="fname" name="Superficie_T" placeholder="Saisir le supérifcie de terrain  .." required>
  </p>
 
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Maps </font></i></label>
  <textarea name="Maps_T" cols="160" rows="10" placeholder="Saisir l'adresse maps .."></textarea>

   
  </p>
    <p>
   <label for="fname"><i><font 
  face="Times New Roman, Times, serif" size="+2" color="#000033">Photo </font></i></label>
    <input type="file" id="fname" name="Affiche_T" placeholder="Sélectionner l'affichee  de terrain .." required>
  </p>
  <p>&nbsp;</p>
 
  <p>
<button class="button"  type="submit" style="vertical-align:middle"><font  color="#000000">Enregistrer</font> </span></button>    <button class="button"  type="reset" style="vertical-align:middle"><span><font  color="#000000"></font>Annuler </span></button>
