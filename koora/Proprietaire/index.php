            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="upcoming_event_1">
                         <img src="../uploadP/<?php echo $Photo_P;?>"        width="500"   height="600"      alt="">
                        <div class="upcoming_event_text">
                            <div class="date">
                                <h3><?php echo $Nom_P;?> <span><?php echo $Prenom_P;?></span> </h3>
                            </div>
                            <div class="time">
                                <ul class="list-unstyle">
                                    <li> <span class="ti-time"></span> <?php echo $Email_P;?></li>
                                    <li> <span class="ti-location-pin"></span> <?php echo $Tel_P;?></li>
                                </ul>
                            </div>
                            <p><?php echo $Adr_P;?> </p>
