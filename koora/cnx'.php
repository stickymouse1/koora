...
<div align="center">
 ...
 $_SESSION['Login']=$Login;
  ...
  $req="SELECT * FROM `administrateur` where Email_A='$Login' and Pwd_A='$Pwd' ";
  $res=mysql_query($req) or die (mysql_error()) ;
  
  $enreg=mysql_fetch_array($res);
  if($enreg)
  {
	  echo("<meta http-equiv='refresh' content='0;URL=Administrateur/index.php' />");
  }
  else
  {
  ...
  $enreg=mysql_fetch_array($res);
        ...
        if($enreg)
          {
	  echo("<meta http-equiv='refresh' content='0;URL=sportif/index.php' />");
          }
		  else
		  {
  ...
  $enreg=mysql_fetch_array($res);
        ...
        if($enreg)
          {
	  echo("<meta http-equiv='refresh' content='0;URL=proprietaire/index.php' />");
          }
		  else
		  {
			echo("<meta http-equiv='refresh' content='0;URL=cnx_erreur.php' />");
		  }
		  }
